  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_invoice.php" class="list-group-item list-group-item-action "><span data-feather="dollar-sign"></span> Invoice</a>
        <a href="accounts-payable.php" class="list-group-item list-group-item-action "><span data-feather="dollar-sign"></span> Acconts Payable</a>
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="add_expense.php"><img src="icon/maex.png" width="57px" />
                      <p>Invoice</p>
                    </a>
                  </div>
                  <div class="col text-center">
